...
export default function JournalModal({ open, onOpenChange, drawnCard }: JournalModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl w-[95vw] max-h-[95vh] overflow-hidden" data-testid="journal-modal">
        <DialogHeader>
                ...
                <div className="relative z-10 h-full p-8 flex flex-col">
                  ...
                  <div className="flex-1 mb-6">
                    <Textarea
                      ...
                      className="w-full h-full resize-none bg-amber-50/90 border-amber-200/50 text-slate-800 placeholder:text-slate-600 p-4 text-base leading-relaxed"
                      maxLength={500}
